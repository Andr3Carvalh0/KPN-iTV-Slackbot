...
module.exports = {
    ...
    BIG_QUERY_ANDROID_TABLE_ID: configuration.BIG_QUERY_ANDROID_TABLE_ID,
    BIG_QUERY_CREDENTIALS: filesystem.fullpath(filesystem.path(__dirname, 'secrets/big_query_credentials.json')),
    BIG_QUERY_IOS_TABLE_ID: configuration.BIG_QUERY_IOS_TABLE_ID,
    ...
    DISABLE_ANDROID_BIG_QUERY: configuration.DISABLE_ANDROID_BIG_QUERY,
    DISABLE_IOS_BIG_QUERY: configuration.DISABLE_IOS_BIG_QUERY,
